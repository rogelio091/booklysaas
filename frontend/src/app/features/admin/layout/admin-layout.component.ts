    ...
    <div class="admin-shell">
      ...
      <aside class="sidebar-glass" [class.open]="drawerOpen()">
        <div class="logo-box">
          ...
          <button class="drawer-close" (click)="drawerOpen.set(false)" aria-label="Cerrar menú">✕</button>
        </div>

        <nav class="nav-menu">
          <a routerLink="/app/appointments" routerLinkActive="active" class="nav-item" (click)="drawerOpen.set(false)">
            <span class="icon">📅</span>
            <span>Agenda de Citas</span>
          </a>
          <a routerLink="/app/services" routerLinkActive="active" class="nav-item" (click)="drawerOpen.set(false)">
            <span class="icon">🛎</span>
            <span>Servicios</span>
          </a>
        </nav>
      ...
      <main class="main-body">
        <header class="topbar-glass">
          <div class="topbar-left">
            ...
            <button class="hamburger" (click)="drawerOpen.set(true)" aria-label="Abrir menú">☰</button>
  ...
  styles: [`
    ...
    .theme-picker {
      ...
      button {
        ...
        transition: all 0.15s;
        &:hover { opacity: 0.9; }
        &.active { opacity: 1; background: var(--color-primary); border-radius: var(--radius-sm); }
      }
    }
    ...
    @media (max-width: 1023px) {
      ...
      .status-text { display: none; } // solo el punto verde en móvil
    ...
    @media (max-width: 767px) {
      ...
      .topbar-glass { padding: 0 0.9rem; }
      .tenant-identity { font-size: 0.85rem; }
    }

    @media (max-width: 479px) {
      .tenant-identity { display: none; } // solo hamburguesa en pantallas muy chicas
    }
  `]
})
